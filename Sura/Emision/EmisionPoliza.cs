...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("a8de89a9-efd1-4c3f-9834-4c598c1caf57", ModuleType.Recording, 1)]
...
#region Variables
        ...
        /// </summary>
        [TestVariable("fac932ed-0f7e-4c4b-b174-78dbdebf2dc7")]
        ...
        /// </summary>
        [TestVariable("da4b9422-c1ea-4ce7-8840-bc084b96c953")]
        ...
        void ITestModule.Run()
        {
            ...
            //Report.Log(ReportLevel.Info, "Wait", "Waiting 30s to exist. Associated repository item: 'SURA.PC.Txt_Validacion.txt_SolicitudDePolizaContratada'", repo.SURA.PC.Txt_Validacion.txt_SolicitudDePolizaContratadaInfo, new ActionTimeout(30000), new RecordItemIndex(4));
            //repo.SURA.PC.Txt_Validacion.txt_SolicitudDePolizaContratadaInfo.WaitForExists(30000);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SURA_ContinueOnFail.btn_Detalles' at Center.", repo.SURA_ContinueOnFail.btn_DetallesInfo, new RecordItemIndex(5));
            ...
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SURA_ContinueOnFail.bttn_AceptarCOF' at Center.", repo.SURA_ContinueOnFail.bttn_AceptarCOFInfo, new RecordItemIndex(7));
            ...
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SURA.PC.Emision.Generales.InformacionDePoliza.Botones.bttn_EmitirPoliza' at Center.", repo.SURA.PC.Emision.Generales.InformacionDePoliza.Botones.bttn_EmitirPolizaInfo, new RecordItemIndex(9));
            //repo.SURA.PC.Emision.Generales.InformacionDePoliza.Botones.bttn_EmitirPoliza.Click();
            //Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SURA.PC.Emision.Generales.InformacionDePoliza.Botones.bttn_Aceptar' at Center.", repo.SURA.PC.Emision.Generales.InformacionDePoliza.Botones.bttn_AceptarInfo, new RecordItemIndex(10));
            //repo.SURA.PC.Emision.Generales.InformacionDePoliza.Botones.bttn_Aceptar.Click();
            //Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 40s to exist. Associated repository item: 'SURA.PC.Txt_Validacion.txt_SolicitudDePolizaContratada'", repo.SURA.PC.Txt_Validacion.txt_SolicitudDePolizaContratadaInfo, new ActionTimeout(40000), new RecordItemIndex(11));
