...
{
    public partial class VerFormulario_EmitidaFlota
    {
        /// <summary>
        ...
        public void fileCheck()
        {
        	...
        	if (!Directory.Exists(@"R:\TEMP\Formularios\"+ NumeroPoliza.TrimStart()+ "\\Flota"))
        	{
        		Report.Info("Info","No se encontro el directorio, comienza la creacion del directorio...");
        		Directory.CreateDirectory(@"R:\TEMP\Formularios\"+ NumeroPoliza.TrimStart()+ "\\Flota");
        ...
        public void moverArchivo(){
        	...
        	string destino = @"R:\TEMP\Formularios\"+ NumeroPoliza.TrimStart() + @"\Flota\" + NombreArchivo.TrimStart();
