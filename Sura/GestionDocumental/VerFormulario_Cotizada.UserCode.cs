...
{
    public partial class VerFormulario_Cotizada
    {
        /// <summary>
        ...
        public void verificarDirectorio(){
        	...
        	if (!Directory.Exists(@"R:\TEMP\Formularios\"+ NumeroTransaccion.TrimStart()))
        	{
        		Report.Info("Info","No se encontro el directorio, comienza la creacion del directorio...");
        		Directory.CreateDirectory(@"R:\TEMP\Formularios\"+ NumeroTransaccion.TrimStart());
        ...
        public void moverArchivo(){
        	...
        	string destino = @"R:\TEMP\Formularios\"+ NumeroTransaccion.TrimStart() +"\\" + NombreArchivo.TrimStart();
