...
namespace Sura.GestionDocumental
{
    public partial class VerFormulario_Cotizada
    {
        ...
        public void verificarDirectorio(){
        	...
        	if (!Directory.Exists(@"C:\TEMP\"+ NumeroTransaccion.TrimStart()))
        	{
        		Report.Info("Info","No se encontro el directorio, comienza la creacion del directorio...");
        		Directory.CreateDirectory(@"C:\TEMP\"+ NumeroTransaccion.TrimStart());
        ...
        public void moverArchivo(){
        	...
        	string destino = @"C:\TEMP\"+ NumeroTransaccion.TrimStart() +"\\" + NombreArchivo.TrimStart();
