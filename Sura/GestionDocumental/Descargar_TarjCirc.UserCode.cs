...
{
    public partial class Descargar_TarjCirc
    {
        /// <summary>
        ...
        public void verificarDirectorio(){
        	...
        	if (!Directory.Exists(@"R:\TEMP\Formularios\TarjCirc\"))
        	{
        		Report.Info("Info","No se encontro el directorio, comienza la creacion del directorio...");
        		Directory.CreateDirectory(@"R:\TEMP\Formularios\TarjCirc\" + NumeroPoliza.TrimStart());
        ...
        public void moverArchivo(){
        	...
        	string destino = @"R:\TEMP\Formularios\TarjCirc\" + NombreArchivo.TrimStart();
