...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The InformacionPoliza_EndosoAdicional recording.
    /// </summary>
    [TestModule("4ddbeb21-44a1-4969-a10b-e77157b885ac", ModuleType.Recording, 1)]
    public partial class InformacionPoliza_EndosoAdicional : ITestModule
    {
        /// <summary>
        ...
        static InformacionPoliza_EndosoAdicional instance = new InformacionPoliza_EndosoAdicional();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public InformacionPoliza_EndosoAdicional()
        {
        }
        ...
        /// </summary>
        public static InformacionPoliza_EndosoAdicional Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SURA.txt_ComisionesDescuentos' at Center.", repo.SURA.txt_ComisionesDescuentosInfo, new RecordItemIndex(5));
            repo.SURA.txt_ComisionesDescuentos.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 40s to exist. Associated repository item: 'SURA.PC.Endosos.lbl_Descuento'", repo.SURA.PC.Endosos.lbl_DescuentoInfo, new ActionTimeout(40000), new RecordItemIndex(6));
